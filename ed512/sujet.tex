...
\author{Michele Pagani \hspace{5em} Thomas Ehrhard (IRIF, CNRS et Paris Cité)}
...
$\LL$ polarisée, possiblement sur la base du système déjà introduit par 
Vaux Auclair dans un cadre non cohérent~\cite{Vaux09a}.
%
...
La thèse sera dirigée par Michele Pagani (professeur à l'ENS de Lyon,
LIP) et Thomas Ehrhard (DR CNRS à l'IRIF, université Paris Cité).

Ehrhard est le co-inventeur avec Regnier du $\lambda$-calcul et de la
$\LL$ différentiels, et a initié et conduit le programme de la
différentiation cohérente, dont le prolongement constitue l’axe
central du projet de thèse.  Pagani a fait de nombreuses contributions
majeures à la sémantique de la Logique Linéaire et développe un
programme de recherche sur l'utilisation des méthodes différentielles
en programmation.

%
La thèse se déroulera à l’ENS de Lyon, avec des visites
régulières de Brasseur à Paris, et de Ehrhard  à Lyon.
